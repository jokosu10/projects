    ...
    implements android.widget.mClickListener
{
    ...
    {
        ArrayList arraylist;
        val$searchCountryAutoComplete.setText((String)adapterview.getItemAtPosition(i));
        ...
        adapterview = (String)(new CommunityAppAsyncTaskHttpCall(MainActivity.access$7(_fld0))).execute(new String[] {
            adapterview, "GET"
        }).get();
...
_L6:
        ...
        MainActivity.access$3(_fld0).addMarker((new MarkerOptions()).title("nearbyMembers").position(adapterview).snippet(jsonobject.toString()));
        ...
        MainActivity.access$11(_fld0).add(adapterview);
...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            searchCountryAutoComplete.setOnItemClickListener(searchPopupDialog. new MainActivity._cls3._cls1());
            searchCountryAutoComplete.setOnKeyListener(new MainActivity._cls3._cls2());
        ...
        // Unreferenced inner class com/community_app_admin/mobile/MainActivity$3$2

/* anonymous class */
        class MainActivity._cls3._cls2
