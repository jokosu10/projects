    ...
    implements android.content.nClickListener
{
    ...
    public void onClick(DialogInterface dialoginterface, int i)
    {
        ...
        saveLocation(4, dialoginterface, val$arg0.getPosition());
    }
...
_L1:
            (new android.app.AlertDialog.Builder(MainActivity.this)).setIcon(0x108009b).setTitle("Save Location").setMessage("Do you want to save this location ?").setPositiveButton("YES", arg0. new MainActivity._cls5._cls1()).setNegativeButton("NO", new MainActivity._cls5._cls2()).show();
_L4:
            return true;
_L2:
...
_L3:
        ...
        // Unreferenced inner class com/community_app_admin/mobile/MainActivity$5$2

/* anonymous class */
        class MainActivity._cls5._cls2
