...
$("#document").ready(function() {
   ...
   function processPageFromVar() {
		...
		$.ajax({
	     	type:'POST',
	         url:'insertToUserLogs.action?userId='+sessionId2+'&fullName='+ sessionName2 +'&action=View&page=InboundRoamersMapTracker_Admin.jsp',
   ...
   function processPage() {
		...
		$.ajax({
	     	type:'POST',
	         url:'insertToUserLogs.action?userId='+sessionId+'&fullName='+ sessionName +'&action=View&page=InboundRoamersMapTracker_Admin.jsp',
	         contentType: 'application/json; charset=utf-8',
	         dataType: 'json'
		});			
	...
	<div id="main">
		<div id="map_header">
			...
			<div class="inboundMap">
				<a onclick="location.href='InboundRoamersMapTracker_Admin.jsp'" style="text-decoration: none;"/><img src= "../images/2.png" style="margin-top: 50px; margin-left: 25px;"><br><label style="font-family: sans-serif; font-size: small; background-color: #ed145b; border-radius: 5px;">Inbound Map</label></a>
			</div>
			<div class="reporting">
