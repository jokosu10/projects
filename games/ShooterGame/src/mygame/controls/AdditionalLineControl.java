...
public class AdditionalLineControl extends AbstractControl {
    ...
    private Vector3f position1() {
        return new Vector3f().interpolate(end11.getPosition(),end12.getPosition(),0.5f);
    }
 
    private Vector3f position2() {
        return new Vector3f().interpolate(end21.getPosition(),end22.getPosition(),0.5f);
    }
