...
public class ParticleManager {
    ...
    public ParticleManager(Node guiNode, Spatial standardParticle, Spatial glowParticle, AppSettings settings) {
    ...
    public void enemyExplosion(Vector3f position) {
        ...
        for (int i=0; i<120; i++) {
            ...
            particle.addControl(new ParticleControl(velocity, 3100, color, appSettings.getWidth(), 
    ...
    public void bulletExplosion(Vector3f position) {
        for (int i=0; i<30; i++) {
            ...
            particle.addControl(new ParticleControl(velocity, 1000, color, appSettings.getWidth(), 
                    appSettings.getHeight()));
            particle.setUserData("affectedByGravity", true);
            ((Node) guiNode.getChild("particles")).attachChild(particle);
        }
   ...
   public void playerExplosion(Vector3f position) {
        ...
        for (int i=0; i<1200; i++) {
            ...
            particle.addControl(new ParticleControl(velocity, 2800, color, appSettings.getWidth(), 
                    appSettings.getHeight()));
            particle.setUserData("affectedByGravity", true);
            ((Node) guiNode.getChild("particles")).attachChild(particle);
        }
    ...
    public void blackHoleExplosion(Vector3f position) {
       ...
       for (int i=0; i<numParticles; i++) {
           ...
           Vector3f velocity = CustomFunctions.getVectorFromAngle(alpha).multLocal(rand.nextFloat()*200 + 300);
           Vector3f pos = position.add(velocity.mult(0.1f));

           Spatial particle = standardParticle.clone();
           particle.setLocalTranslation(pos);
           particle.addControl(new ParticleControl(velocity, 1000, color, appSettings.getWidth(), appSettings.getHeight()));
    ...
    public void sprayParticle(Vector3f position, Vector3f sprayVel) {
        ...
        particle.addControl(new ParticleControl(sprayVel, 3500, color, appSettings.getWidth(), appSettings.getHeight()));
        particle.setUserData("affectedByGravity", true);
        ((Node) guiNode.getChild("particles")).attachChild(particle);
    }    
    ...
    public void makeExhaustFire(Vector3f position, float rotation) {
        ...
        Vector3f direction = CustomFunctions.getVectorFromAngle(rotation);
        ...
        Vector3f pos = position.add(CustomFunctions.getVectorFromAngle(rotation).multLocal(-25f));

        //middle stream
        Vector3f randVec = CustomFunctions.getVectorFromAngle(new Random().nextFloat() * FastMath.PI * 2);
        ...
        particleMid.addControl(new ParticleControl(velMid, 800, midColor, appSettings.getWidth(), appSettings.getHeight()));
        ...
        particleMidGlow.addControl(new ParticleControl(velMid, 800, midColor, appSettings.getWidth(), appSettings.getHeight()));
        particleMidGlow.setUserData("affectedByGravity", true);
        ((Node) guiNode.getChild("particles")).attachChild(particleMidGlow);

        //side streams
        Vector3f randVec1 = CustomFunctions.getVectorFromAngle(new Random().nextFloat() * FastMath.PI * 2);
        Vector3f randVec2 = CustomFunctions.getVectorFromAngle(new Random().nextFloat() * FastMath.PI * 2);
        ...
        particleSide1.addControl(new ParticleControl(velSide1, 800, sideColor, appSettings.getWidth(), appSettings.getHeight()));
        ...
        particleSide2.addControl(new ParticleControl(velSide2, 800, sideColor, appSettings.getWidth(), appSettings.getHeight()));
        ...
        particleSide1Glow.addControl(new ParticleControl(velSide1, 800, sideColor, appSettings.getWidth(), appSettings.getHeight()));
        ...
        particleSide2Glow.addControl(new ParticleControl(velSide2, 800, sideColor, appSettings.getWidth(), appSettings.getHeight()));
